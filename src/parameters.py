...
import numpy as np
from src.distributions import TfKumaraswamy, TfLogNormal, TfNormal, TfTruncatedNormal, TfConstant
...
class DistributionDescription(object):
    def __init__(self, name, class_type, defaults):
        ...
        if class_type == TfNormal or  class_type == TfLogNormal:
            ...
            self.dependencies = [mu_dependency, prec_dependency] #dependency表明这个distribution具体依赖于哪一个参数
